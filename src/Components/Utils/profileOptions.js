...
export const options = [
  {
    ...
    data: [
      ...
      { id: 2, name: 'Quick Access', icon: 'book', modal: 'QuickAccess' },
  ...
  },
  {
    ...
    data: [
      { id: 6, name: 'About Us', icon: 'info', value: 'Risaa Bookstore', route: 'AuthorInfoScreen' },
      { id: 7, name: 'Privacy Policy', icon: 'privacy-tip', action: 'PrivacyPolicy' },
  ...
  },
  {
    title: 'Developer',
    data: [
      { id: 11, name: 'About Developer', icon: 'face', route: 'DeveloperInfoScreen' },
    ],
  },
];